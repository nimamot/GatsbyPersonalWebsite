  ...
  const softwareEngineering = [
    {
      ...
      desc: "Leetrack solves the common problem of students and job seekers relying on spreadsheets to track their coding practice, while enabling them to share their progress and achievements with others. This full-stack application transforms how interview candidates monitor their progress, showcase their coding journey, and maintain consistency in their coding preparation.\n\n<div class=\"my-6\"><img src=\"/static/leetrack-dashboard.png\" alt=\"Leetrack Dashboard Screenshot\" class=\"w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">🎨 Modern Frontend</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Built with TypeScript, Vite, and Tailwind CSS for a responsive, intuitive user interface that works seamlessly across all devices</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">📊 Analytics Dashboard</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Interactive charts, GitHub-style activity heatmaps, and streak tracking powered by Recharts with 365 days of activity data</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">🔗 Public API</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">RESTful API endpoints with CORS support, rate limiting, and JSON responses under 200ms for embeddable widgets</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">🔒 Secure Backend</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Supabase-powered PostgreSQL database with Row Level Security, real-time subscriptions, and zero-downtime deployments</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">🛡️ Privacy Controls</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Granular privacy controls allowing users to make profiles public/private with opt-in data exposure and 5-minute refresh intervals</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Comprehensive quantitative trading analysis platform built with Streamlit providing real-time financial data analysis, technical indicators, backtesting capabilities, and sentiment analysis.\n\n<div class=\"my-6\"><img src=\"/static/quant.png\" alt=\"Quantitative Trading Analysis Platform Screenshot\" class=\"w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">📊 Real-time Analysis</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Live market data processing with Yahoo Finance API integration for accurate trading insights and real-time market monitoring</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">📈 Technical Indicators</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Moving average crossover strategies, RSI mean reversion, and volatility analysis with comprehensive backtesting capabilities</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">💭 Sentiment Analysis</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">VADER sentiment analysis from Reddit and Google News to gauge market sentiment and social media impact</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">📊 Interactive Charts</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Plotly-powered charts and graphs for comprehensive data visualization and interactive financial analysis</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">🌐 Web Interface</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">User-friendly Streamlit web application for easy access to trading tools and analytics across all devices</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Full-stack web application that revolutionizes how friends split and track expenses during trips with smart expense tracking and automatic equal splitting.\n\n<div class=\"my-6\"><img src=\"/static/tripExpense.png\" alt=\"Trip Expense Tracker Screenshot\" class=\"w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">💰 Smart Tracking</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Automatic equal splitting with real-time balance calculation and comprehensive expense categorization for seamless trip management</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">👥 Group Management</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Shareable links for easy group creation and member management with secure access controls and role-based permissions</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">📊 Dashboard</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Real-time expense overview with visual charts and detailed transaction history for complete financial transparency</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">📈 Analytics</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">CSV export functionality and AI-powered settlement suggestions for optimal payment distribution and expense insights</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">⚡ Tech Stack</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Next.js 14 with TypeScript, Tailwind CSS, Supabase backend, and Framer Motion animations for seamless user experience</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Designed and developed a peer-to-peer advising platform that connects students with mentors for personalized guidance and support.\n\n<div class=\"my-6\"><img src=\"/static/peerAdvice.png\" alt=\"PeerAdvice Platform Screenshot\" class=\"w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">🔐 Authentication</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Google OAuth and Firebase integration for secure user registration and login with seamless social authentication</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">📅 Scheduling</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Calendly API integration for seamless mentor-student meeting coordination and automated appointment management</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">🗄️ Database</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">PostgreSQL backend for storing user profiles, appointments, and conversation history with robust data management</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">🎨 Frontend</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">HTML, CSS, and JavaScript for intuitive user experience and responsive design across all devices</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">⚡ Agile Dev</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Applied Agile methodologies for efficient project management and collaborative development in hackathon environment</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Constructed a comprehensive messenger app for iOS that enables users to create accounts, connect with others, and share multimedia content seamlessly.\n\n<div class=\"my-6\"><img src=\"/static/Massenger.png\" alt=\"mAssenger iOS App Screenshot\" class=\"w-full max-w-lg mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">🔐 Authentication</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Email-based account creation and login with secure Firebase cloud services integration for reliable user management</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">🔍 User Discovery</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Search functionality to find and connect with other users on the platform with intuitive discovery features</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">📱 Multimedia</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Support for texts, pictures, videos, and location sharing in conversations with rich media capabilities</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">☁️ Cloud Storage</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Firebase backend for storing user data, conversations, and media with automatic synchronization across devices</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">📱 iOS Native</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Native Swift and Ruby implementation for optimal performance and seamless user experience on iOS devices</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Interactive Spanish learning platform that combines music and language education for engaging vocabulary and grammar practice.\n\n<div class=\"my-6\"><img src=\"/static/laLetra.png\" alt=\"La Letra Spanish Learning Platform Screenshot\" class=\"w-full max-w-2xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">🎵 Song Learning</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Interactive platform using music to teach Spanish vocabulary and grammar in an engaging and memorable way</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">🌐 Web App</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Django-powered backend with HTML and CSS frontend for responsive user experience across all devices</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">☁️ Cloud Hosting</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">PythonAnywhere hosting for reliable and accessible online learning platform with 24/7 availability</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">📚 Content</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Structured lessons and practice exercises integrated with musical content for comprehensive learning</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">🎨 Interface</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Intuitive design for seamless learning experience across different devices with user-friendly navigation</span></div></div></div>",
  ...
  const dataScience = [
    {
      ...
      desc: "Designed and implemented a scalable data pipeline using AWS Lambda, S3, and DynamoDB to automate financial statement analysis and generate comprehensive reports.\n\n<div class=\"my-6\"><img src=\"https://private-user-images.githubusercontent.com/64922998/485902035-8d72843f-9415-4806-87a6-f13152aba5e4.png?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..2KEWQ_4JD_LuXsSpIsNxYBn7HMonjlKFLErsHFqZDrs\" alt=\"Automated Financial Analysis Pipeline Screenshot\" class=\"w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">☁️ Cloud Infrastructure</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">AWS Lambda, S3, and DynamoDB for scalable data processing and storage with serverless architecture</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">📊 Data Processing</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Automated analysis of user-uploaded CSV financial statements with comprehensive reporting and insights</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">🔍 Analytics</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Flagged transaction detection, spending trend visualization, and recurring transaction analysis</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">📄 Report Generation</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Automated creation of detailed financial analysis reports for end users with professional formatting</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">🐍 Python Stack</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Leveraged Python for data processing, visualization, and machine learning insights with robust libraries</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Built a comprehensive machine learning pipeline using multiple algorithms to forecast Bitcoin prices with advanced feature engineering and optimization techniques.\n\n<div class=\"my-6\"><img src=\"/static/btcPrediction.png\" alt=\"Bitcoin Price Prediction Model Screenshot\" class=\"w-full max-w-4xl mx-auto rounded-lg shadow-lg border border-gray-200 dark:border-gray-700\" /></div>\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">🤖 ML Models</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Linear Regression, KNN, Random Forest, XGBoost, CatBoost, and LSTM for comprehensive price prediction</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">⚙️ Feature Engineering</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Advanced techniques to extract meaningful patterns from time-series cryptocurrency data with domain expertise</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">🎯 Optimization</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Systematic hyperparameter tuning to enhance model accuracy and capture temporal dependencies</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">🔄 Preprocessing</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Automated data cleaning and transformation pipelines for optimal model performance and reliability</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">📈 Time Series</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Advanced regression analysis to uncover meaningful patterns in cryptocurrency market data and trends</span></div></div></div>",
    ...
    },
    {
      ...
      desc: "Implemented a comprehensive relational database system for sports management using Oracle DB and SQL with advanced data organization and user-friendly web interface.\n\n<div class=\"mt-6\"><h3 class=\"text-xl font-bold text-gray-900 dark:text-white mb-4\">🚀 Key Features & Tech Stack</h3><div class=\"space-y-4\"><div class=\"flex items-start gap-4\"><span class=\"text-blue-600 dark:text-blue-400 font-semibold w-40 flex-shrink-0\">🗄️ Database Design</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Oracle DB implementation with comprehensive data organization for sports management and analytics</span></div><div class=\"flex items-start gap-4\"><span class=\"text-green-600 dark:text-green-400 font-semibold w-40 flex-shrink-0\">🔍 SQL Operations</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Complex queries and data manipulation for powerful insights and analytics with advanced database operations</span></div><div class=\"flex items-start gap-4\"><span class=\"text-purple-600 dark:text-purple-400 font-semibold w-40 flex-shrink-0\">🌐 Web Interface</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">User-friendly web application for efficient database interaction and data visualization across devices</span></div><div class=\"flex items-start gap-4\"><span class=\"text-orange-600 dark:text-orange-400 font-semibold w-40 flex-shrink-0\">🛡️ Error Handling</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Robust input validation and error handling for reliable user experience and data integrity</span></div><div class=\"flex items-start gap-4\"><span class=\"text-pink-600 dark:text-pink-400 font-semibold w-40 flex-shrink-0\">📊 Data Management</span><span class=\"text-gray-700 dark:text-gray-300 flex-1\">Comprehensive sports data organization with efficient storage and retrieval systems for optimal performance</span></div></div></div>",
